...
const CounterLabels = () => {
  ...
  return (
    <div className="my-10 lg:my-20">
      <div className=" card-label  h-[120px] md:h-auto  poppins   w-[95%] lg:w-[90%] mx-auto ">
        <div className="rounded-[0.8rem]   bg-zinc-800 label-bg   text-white flex p-3  py-8   md:p-16">
          <div className=" space-y-4 md:space-y-8 w-full flex  flex-col items-center justify-center">
