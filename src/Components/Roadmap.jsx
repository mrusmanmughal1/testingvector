...
const Roadmap = () => {
  ...
  return (
    <div>
      <div className="flex justify-center flex-col items-center  relative md:py-20">
        ...
        <div className="md:border md:bordershaow flex md:flex-row gap-10  flex-col justify-center  items-center   relative rounded-2xl md:rounded-[5rem] h-auto md:h-[430px] w-[90%] md:w-[60%] mx-auto border-cyan-400">
          ...
          <div className="md:absolute  w-full md:w-[30rem]   bg-stone-800 rounded-2xl md:rounded-2xl   top-[35%] -left-16 md:-left-56  border-cyan-500 border-b-0  border-2 px-6  md:ps-6 py-4 md:py-4 text-white border-dashed">
          ...
          <div className="md:absolute   w-full md:w-[30rem]    bg-stone-800  rounded-2xl md:rounded-2xl  top-[35%] -right-16 md:-right-56  border-cyan-500 border-b-0  border-2  px-6  md:ps-6 py-4 md:py-4 text-white border-dashed">
          ...
          <div className="md:absolute  z-40  w-full md:w-[30rem]  bg-stone-800  rounded-2xl md:rounded-2xl   -bottom-10 md:-bottom-40  border-cyan-500 border-b-0   border-2 px-6 md:ps-6 py-4 md:py-10 text-white border-dashed">
   ...
   ">
        ...
        <div className="md:absolute mt-10 md:mt-0  z-40 w-full md:w-[30rem]   bg-stone-800 rounded-2xl md:rounded-2xl    top-[50%]    border-cyan-500 border-b-0   border-2 px-6 md:ps-6 py-4 md:py-10 text-white border-dashed">
