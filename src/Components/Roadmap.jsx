...
const Roadmap = () => {
  return (
    <div>
      <div className="flex justify-center flex-col items-center  relative py-20">
        ...
        <div className="border bordershaow flex justify-center items-center   relative rounded-[5rem] h-[430px] w-[60%] mx-auto border-cyan-400">
          <div className="absolute  w-96 z-50    roadbg  rounded-2xl -top-10  border-cyan-300  border-2  px-6  py-6 text-white border-dotted">
          ...
          <div className="absolute  w-96   roadbg  rounded-2xl   top-[35%] -left-56  border-cyan-300  border-2  px-6 py-4 text-white border-dotted">
          ...
          <div className="absolute   w-96  roadbg  rounded-2xl  top-[35%] -right-56  border-cyan-300  border-2  px-6 py-4 text-white border-dotted">
          ...
          <div className="absolute  z-40  w-96  roadbg  rounded-2xl  -bottom-40  border-cyan-300   border-2  px-6 py-10 text-white border-dotted">
   ...
   ">
        <div className="absolute  z-40  w-96  roadbg  rounded-2xl    top-[50%]    border-cyan-300   border-2  px-6 py-10 text-white border-dotted">
