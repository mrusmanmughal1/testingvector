...
const Roadmap = () => {
  return (
    <div>
      ...
      <div className="relative w-[60%] h-96 mx-auto -top-20 border-t border-cyan-300 rounded-t-[5rem]
  before:content-[''] before:absolute before:top-0 before:left-0 before:w-1/2 before:h-[50%] 
  before:border-l before:border-cyan-300 before:rounded-tl-[5rem]
  after:content-[''] after:absolute after:top-0 after:right-0 after:w-1/2 after:h-[50%] 
  after:border-r after:border-cyan-300 after:rounded-tr-[5rem]">
